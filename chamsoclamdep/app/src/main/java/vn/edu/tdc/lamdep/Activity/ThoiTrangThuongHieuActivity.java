...
import vn.edu.tdc.lamdep.Adapter.thoiTrangThuongHieuAdapter;
...
public class ThoiTrangThuongHieuActivity extends AppCompatActivity {
    ...
    thoiTrangThuongHieuAdapter thuongHieuAdapter;
    ...
    ThoiTrangThuongHieuActivity.mHandler mHandler;
    ...
    private void getData(int Page) {
        ...
        String duongdan = "http://192.168.137.147/server/getsanpham1.php?page=" + String.valueOf(Page);
        ...
        lvthuonghieu.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                if (firstVisibleItem + visibleItemCount == totalItemCount && totalItemCount != 0 && Loading == false && limitdata == false) {
                    Loading = true;
                    ThoiTrangThuongHieuActivity.ThreadData threadData = new ThoiTrangThuongHieuActivity.ThreadData();
                    threadData.start();
                }
            }
        });
    ...
    private void setControl() {
        lvthuonghieu = findViewById(R.id.listviewthuonghieu);
        mangthuonghieu = new ArrayList<>();
        thuongHieuAdapter = new thoiTrangThuongHieuAdapter(getApplicationContext(), mangthuonghieu);
        lvthuonghieu.setAdapter(thuongHieuAdapter);
        LayoutInflater inflater = (LayoutInflater) getSystemService(LAYOUT_INFLATER_SERVICE);
        footerview = inflater.inflate(R.layout.progressbar, null);
        mHandler = new ThoiTrangThuongHieuActivity.mHandler();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menugiohang:
                intent = new Intent(ThoiTrangThuongHieuActivity.this, cartActivity.class);
                startActivity(intent);
                break;
            case R.id.menuseachview:
                intent = new Intent(ThoiTrangThuongHieuActivity.this, TimKiemSanPham.class);
                startActivity(intent);
                break;
